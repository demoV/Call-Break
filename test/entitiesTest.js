...
describe('dealer', function(){
	var cards = [ { suit: 'clubs', rank: 11 },
					  ...
					  { suit: 'clubs', rank: 8 },
					  { suit: 'heart', rank: 10 } ]
	var players = {p1:{name:'akshay',hands:[]},p2:{name:'lalit',hands:[]},p3:{name:'durga',hands:[]},p4:{name:'vinay',hands:[]}};
	...
	describe('distribute', function(){
		it('checks the length of hands of each player after distribution', function(){
			...
			distribute(players)
			console.log(players.p1.hands)
			expect(players.p1.hands).to.have.length(13);
			expect(players.p2.hands).to.have.length(13);
			expect(players.p3.hands).to.have.length(13);
			expect(players.p4.hands).to.have.length(13);
		});
