...
PointTable.prototype = {
    ...
    currentRoundPoints : function(players){
        return Object.keys(players).reduce(function(currentRoundData,playerName){
            ...
            currentRoundData[playerName]['score'] = PointTable.prototype.countScore(currentRoundData,playerName);
    ...
    updatePointTableOf : function(players,previousPointsData){
        if(Object.keys(pointTableFileData).length < this.NoOfRounds){
           var roundPoint = PointTable.prototype.currentRoundPoints(players);
            PointTable.prototype.addDataInFile(roundPoint,previousPointsData);
        };
    },
