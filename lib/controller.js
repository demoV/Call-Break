...
var updatePointTable = function(req,res,next,game){
    game.updatePointTable();
    next();
};

var serverPointTable = function(req,res,next,game){
    res.end(JSON.stringify(game.pointTable.getPointTable()));
};
...
var get_handlers = [
    ...
    {path: '^/html/updatePonintTable', handler: updatePointTable},
    {path: '^/html/serverPointTable', handler: serverPointTable},
